	...
	>
		...
		<div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
			...
			<div>
				...
				>
					<a
						@click.prevent="changeActivePage('prev')"
						href="#"
					...
					<a
						v-for="pageNum of pages"
						:key="pageNum"
						href="#"
						@click.prevent="changeActivePage(pageNum)"
					...
					<a
						@click.prevent="changeActivePage('next')"
						href="#"
...
<script setup>
const props = defineProps(['total', 'to', 'from'])
const emit = defineEmits(['changePage'])

const showingTo = computed(() =>
	props.to >= props.total ? props.total : props.to
)

const pages = computed(() => Math.ceil(props.total / 10))
